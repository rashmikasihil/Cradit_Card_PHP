...
if (isset($_POST["submit"])) {
   ...
   $sql = "INSERT INTO payment (`number`, `holder`, `month`, `year`, `cvv`) VALUES ( '$number', '$holder', '$month', '$year', '$cvv')";
...
<div class="container">
    ...
    <form action="" method="post" >
        <div class="inputBox">
            ...
            <input type="text" maxlength="16" name="number" class="card-number-input">
        </div>
        <div class="inputBox">
            <span>card holder</span>
            <input type="text" name="holder" class="card-holder-input">
        </div>
        <div class="flexbox">
            <div class="inputBox">
